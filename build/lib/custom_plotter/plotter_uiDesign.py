...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Data_Name = QtWidgets.QLineEdit(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Data_Name.sizePolicy().hasHeightForWidth())
        self.Data_Name.setSizePolicy(sizePolicy)
        self.Data_Name.setObjectName("Data_Name")
        self.horizontalLayout_2.addWidget(self.Data_Name)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnPreviousSimilarY.setToolTip(_translate("MainWindow", "Jump one window back in time"))
        self.btnPreviousSimilarY.setText(_translate("MainWindow", "<|"))
        self.btnPrevious.setToolTip(_translate("MainWindow", "Jump 0.3*window back in time"))
        self.btnPrevious.setText(_translate("MainWindow", "<"))
        self.btnNext.setToolTip(_translate("MainWindow", "Jump 0.3*window forward in time"))
        self.btnNext.setText(_translate("MainWindow", ">"))
        self.btnNextSimilarY.setToolTip(_translate("MainWindow", "Jump one window forward in time"))
